(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["photo-swiper"] = factory(require("vue"));
	else
		root["photo-swiper"] = factory(root["Vue"]);
...
var PhotoSwipervue_type_script_lang_ts_PhotoSwiper = /*#__PURE__*/function (_Vue) {
  _inherits(PhotoSwiper, _Vue);

  var _super = _createSuper(PhotoSwiper);
  ...
  _createClass(PhotoSwiper, [{
    ...
    key: "setPagePosition",
    get: function get() {
      if (_typeof(this.pageIndex) === 'object') {
...
__decorate([Prop()], PhotoSwipervue_type_script_lang_ts_PhotoSwiper.prototype, "gallerySelector", void 0);

__decorate([Prop()], PhotoSwipervue_type_script_lang_ts_PhotoSwiper.prototype, "gallerySelectorItem", void 0);

__decorate([Watch('visible')], PhotoSwipervue_type_script_lang_ts_PhotoSwiper.prototype, "toggleGallery", null);

PhotoSwipervue_type_script_lang_ts_PhotoSwiper = __decorate([vue_class_component_esm({
  components: {}
...
// CONCATENATED MODULE: ./src/components/PhotoSwiper/index.ts


var components = components_PhotoSwiper;

components.install = function (Vue) {
  Vue.component(components_PhotoSwiper.name, components_PhotoSwiper);
};

/* harmony default export */ var src_components_PhotoSwiper = (components_PhotoSwiper);
// CONCATENATED MODULE: ./src/components/index.ts


 // 存储组件列表

var components_components = [src_components_PhotoSwiper]; // 定义 install 方法，接收 Vue 作为参数。如果使用 use 注册插件，则所有的组件都将被注册
...
/* harmony default export */ var src_components = ({
  ...
  install: install,
  // 以下是具体的组件列表
  PhotoSwiper: src_components_PhotoSwiper
});
